...
public class PaymentsUtil {
    ...
    /**
     * Creates an instance of {@link PaymentsClient} for use in an {@link Activity} using the default test
     * environment
     *
     ...
     * and make updates in Constants.java.</p>
     *
     * <p>The Google Pay API might return cards on file on Google.com (PAN_ONLY) or a device token on an Android device authenticated with a 3-D Secure cryptogram (CRYPTOGRAM_3DS).</p>
     *
